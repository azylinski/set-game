...
define("core/model", ["require", "exports", "js-combinatorics"], function (require, exports, js_combinatorics_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    js_combinatorics_1 = __importDefault(js_combinatorics_1);
    /*
...
*/ 
define("utils/generate-svg-icons", ["require", "exports", "fs", "core/model"], function (require, exports, fs, model_1) {
    "use strict";
    var e_3, _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    fs = __importStar(fs);
    var pug = require("pug");
    var renderFn = pug.compileFile("src/utils/svg.pug", {
        pretty: true,
        debug: false,
        inlineRuntimeFunctions: true
    });
    var deck = new model_1.Deck();
    try {
        for (var deck_1 = __values(deck), deck_1_1 = deck_1.next(); !deck_1_1.done; deck_1_1 = deck_1.next()) {
            var card = deck_1_1.value;
            var fn = "public/icons/" + card + ".svg";
